...
func (s *Store) Reserve(applicantID string, applicantName string, ip net.IP, rangeID string) (bool, error) {
...
func (s *Store) ReleaseByID(applicantID string, applicantName string) error {
	ipPool, err := s.iPPoolCache.Get(s.iPPoolName)
	if err != nil {
		return err
	}
...
func (s *Store) GetByID(applicantID string, applicantName string) []net.IP {
	ipPool, err := s.iPPoolCache.Get(s.iPPoolName)
