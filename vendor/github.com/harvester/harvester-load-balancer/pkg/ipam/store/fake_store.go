...
func (f *FakeStore) Reserve(applicantID string, ifname string, ip net.IP, rangeID string) (bool, error) {
	ipStr := ip.String()
...
func (f *FakeStore) LastReservedIP(rangeID string) (net.IP, error) {
...
func (f *FakeStore) ReleaseByID(applicantID string, applicantName string) error {
	if f.pool.Status.Allocated == nil {
		return nil
	}
...
func (f *FakeStore) GetByID(applicantID string, applicantName string) []net.IP {
	if f.pool.Status.Allocated == nil {
		return nil
	}
