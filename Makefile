...
MK_VALIDATE_CACHE_IMAGE  := harvester-cloud-provider-image-builder-validate-cache:$(MK_REPO_ID)
MK_TEST_CACHE_IMAGE      := harvester-cloud-provider-image-builder-test-cache:$(MK_REPO_ID)
